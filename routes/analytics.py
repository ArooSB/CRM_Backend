...
def create_analytics_entry():
    ...
    new_analytics = Analytics(
        ...
        metric_value=data['metric_value'].lower()  # Ensure metric value is lowercase
    )
    ...
    # Return the success response with the analytics_id of the created record
    return jsonify({
        "message": "Analytics entry created successfully!",
        "analytics_id": new_analytics.analytics_id  # This is auto-generated by SQLAlchemy
    }), 201
